...
public class ReplyActionStrategyTests
{
    private readonly Mock<IUnitOfWork> _mockUnitOfWork;
    private readonly ReplyActionStrategy _strategy;

    public ReplyActionStrategyTests()
    {
        _mockUnitOfWork = new Mock<IUnitOfWork>();
        _strategy = new ReplyActionStrategy(_mockUnitOfWork.Object);
    }

    [Fact]
    public async Task ExecuteAsync_ReplyActionWithParentId_ShouldPrependParentNameToCommentBody()
    {
        // Arrange
        ...
        // Assert
        var expectedBody = "Parent Commenter, New comment text.";
    ...
    [Fact]
    public void CanExecute_ReplyAction_ShouldReturnTrue()
    {
        // Act
        var result = _strategy.CanExecute(CommentConstants.Reply);
    ...
    [Fact]
    public void CanExecute_NonReplyAction_ShouldReturnFalse()
    {
        // Act
