...
public class OrdersAccessRule(ICurrentUserService currentUserService) : IPageAccessRule
{
    ...
    {
        return await currentUserService.HasPermissionToAsync(nameof(UserPermissionTypes.ViewOrders), cancellationToken);
    }
}