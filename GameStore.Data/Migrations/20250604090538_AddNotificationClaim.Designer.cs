...
namespace GameStore.Data.Migrations
{
    ...
    [Migration("20250604090538_AddNotificationClaim")]
    partial class AddNotificationClaim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Game", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Genre", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.PaymentMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Platform", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Publisher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.UserEntities.User", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("UserNotificationTypes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 15,
                            ClaimType = "permission",
                            ClaimValue = "ReceiveNotificationOnOrderStatusChange",
                            RoleId = new Guid("308660dc-ae51-480f-824d-7dca6714c3e2")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Comment", b =>
                {
                    b.HasOne("GameStore.Domain.Entities.CoreEntities.Game", "Game")
                        .WithMany("Comments")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GameStore.Domain.Entities.CoreEntities.Comment", "Parent")
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Game", b =>
                {
                    b.HasOne("GameStore.Domain.Entities.CoreEntities.Publisher", "Publisher")
                        .WithMany("Games")
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.CoreEntities.Genre", b =>
                {
                    b.HasOne("GameStore.Domain.Entities.CoreEntities.Genre", "ParentGenre")
                        .WithMany("SubGenres")
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.Relations.GameGenre", b =>
                {
                    ...
                    b.HasOne("GameStore.Domain.Entities.CoreEntities.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.Relations.GamePlatform", b =>
                {
                    ...
                    b.HasOne("GameStore.Domain.Entities.CoreEntities.Platform", "Platform")
                        .WithMany()
            ...
            modelBuilder.Entity("GameStore.Domain.Entities.Relations.OrderGame", b =>
                {
                    b.HasOne("GameStore.Domain.Entities.CoreEntities.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GameStore.Domain.Entities.CoreEntities.Game", "Product")
                        .WithMany()
